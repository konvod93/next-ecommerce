...
const CustomizeProducts = ({
    ...
    return (
        <div className="flex flex-col gap-6">
                    ...
                    <ul className="flex items-center gap-3">
                        {option.choices?.map((choice) => {
                            ...
                            return option.name === "Цвет" ?
                                (<li
                                    className="w-8 h-8 rounded-full ring-1 ring-gray relative"
            ...
            {/* 
                    <ul className="flex items-center gap-3">
                        <li className="w-8 h-8 rounded-full ring-1 ring-gray cursor-pointer relative bg-red-500">
                            <div className="absolute w-10 h-10 rounded-full ring-2 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2" />
                        </li>
                        <li className="w-8 h-8 rounded-full ring-1 ring-gray cursor-pointer relative bg-blue-500"> </li>
                        <li className="w-8 h-8 rounded-full ring-1 ring-gray cursor-pointer relative bg-green-500">
            ...
            <ul className="flex items-center gap-3">
                ...
                <li className="ring-1 ring-lama text-white bg-lama rounded-md py-1 px-4 text-sm cursor-not-allowed">Medium</li>
